...
static int match_keyword(const char *word) {
    ...
    struct { const char *word; TokenType type; } keywords[] = {
        ...
        {"f8", TOKEN_TYPE_F8}, {"f16", TOKEN_TYPE_F16}, {"f32", TOKEN_TYPE_F32}, {"f64", TOKEN_TYPE_F64}, {"num", TOKEN_TYPE_NUM},
...
const char *token_type_to_str(TokenType type) {
    ...
    switch (type) {
        ...
        CASE(TOKEN_TYPE_F8); CASE(TOKEN_TYPE_F16); CASE(TOKEN_TYPE_F32); CASE(TOKEN_TYPE_F64); CASE(TOKEN_TYPE_NUM); CASE(TOKEN_TYPE_VOID);
